...
@Builder
public class DeleteNode implements ApiRequest<Success> {

    private final Integer id; // Required

    @Builder.Default private final Boolean deleteChildren = false;
    ...
    public List<XenNameValuePair> body() {
        return List.of(new XenNameValuePair("delete_children", this.deleteChildren));
    }
