...
@Builder
public class GetFlattenedNodes implements ApiRequest<FlattenedNodes> {

    @Override
    public XenforoPaths getPath() {
        return XenforoPaths.NODES_FLAT;
    }
    ...
    @Override
    public Class<FlattenedNodes> response() {
        return FlattenedNodes.class;
    }
}
