...
@Builder
public class PostNode implements ApiRequest<NodesPost> {

    private final String title; // Required
    private final String name;
    private final String description;
    private final Integer parentNodeId; // Required
    private final Integer displayOrder;
    @Builder.Default private final Boolean displayInList = true;
    private final List<String> typeData;
    private final TypeNodeId nodeTypeId; // Required

    @Override
    public XenforoPaths getPath() {
        return XenforoPaths.NODES;
    }
    ...
    public List<XenNameValuePair> body() {
        ...
        if (this.nodeTypeId != null)
            params.add(new XenNameValuePair("node_type_id", this.nodeTypeId.getNodeType()));
