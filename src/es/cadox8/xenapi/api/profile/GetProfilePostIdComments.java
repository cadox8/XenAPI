...
@Builder
public class GetProfilePostIdComments implements ApiRequest<GetProfilePostsByIdCommentsResponse> {
    ...
    public XenforoPaths getPath() {
        return XenforoPaths.PROFILE_POST_ID_COMMENTS;
    }
    ...
    @Override
    public Class<GetProfilePostsByIdCommentsResponse> response() {
        return GetProfilePostsByIdCommentsResponse.class;
    }
}
