...
@Builder
public class PostProfilePost implements ApiRequest<ProfilePostResponse> {
    ...
    public XenforoPaths getPath() {
        return XenforoPaths.PROFILE_POST;
    }
    ...
    @Override
    public Class<ProfilePostResponse> response() {
        return ProfilePostResponse.class;
    }
}
