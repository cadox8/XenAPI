...
@Builder
public class PostProfilePostComments implements ApiRequest<ProfilePostCommentsResponse> {
    ...
    public XenforoPaths getPath() {
        return XenforoPaths.PROFILE_POST_COMMENTS;
    }
    ...
    public List<XenNameValuePair> body() {
        ...
        list.add(new XenNameValuePair("profile_post_id", this.profilePostId));
