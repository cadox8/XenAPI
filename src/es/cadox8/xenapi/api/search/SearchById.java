...
public class SearchById implements ApiRequest<IdSearch> {
    ...
    public List<XenNameValuePair> params() {
        if (this.page == null)
            return List.of();
        return List.of(new XenNameValuePair("page", String.valueOf(this.page)));
    }
    ...
    @Override
    public Class<IdSearch> response() {
